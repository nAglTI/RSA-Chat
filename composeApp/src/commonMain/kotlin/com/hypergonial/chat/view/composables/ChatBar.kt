...
/** A chat bar that allows the user to type messages and send them.
 * It supports multi-line input, sending messages on enter, and dropping focus on escape.
 *
 ...
 * @param onFocusGain The callback to call when the chat bar gains focus,
 * this will not be invoked when focus is initially requested due to shouldGrabFocus

 ...
 * @param nonce The nonce of the message. This can be set by the client to track message delivery, and is returned by
 *   the gateway upon a successful MESSAGE_CREATE.
...
data class Message(
    ...
    @SerialName("edited") val isEdited: Boolean = false,
